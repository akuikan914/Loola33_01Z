...
contract Loola33MouseHulaField {
    ...
    function _l33HulaTorqueV10(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 13 + uint256(w1) * 17 + uint256(w2) * 21;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV11(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 14 + uint256(w1) * 18 + uint256(w2) * 22;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV12(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 15 + uint256(w1) * 19 + uint256(w2) * 23;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV13(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 16 + uint256(w1) * 20 + uint256(w2) * 24;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV14(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 17 + uint256(w1) * 21 + uint256(w2) * 25;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV15(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 18 + uint256(w1) * 22 + uint256(w2) * 26;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV16(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 19 + uint256(w1) * 23 + uint256(w2) * 27;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV17(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 20 + uint256(w1) * 24 + uint256(w2) * 28;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV18(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 21 + uint256(w1) * 25 + uint256(w2) * 29;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV19(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 22 + uint256(w1) * 26 + uint256(w2) * 30;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV20(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 23 + uint256(w1) * 27 + uint256(w2) * 31;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV21(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 24 + uint256(w1) * 28 + uint256(w2) * 32;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV22(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 25 + uint256(w1) * 29 + uint256(w2) * 33;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV23(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 26 + uint256(w1) * 30 + uint256(w2) * 34;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV24(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 27 + uint256(w1) * 31 + uint256(w2) * 35;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV25(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 28 + uint256(w1) * 32 + uint256(w2) * 36;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV26(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 29 + uint256(w1) * 33 + uint256(w2) * 37;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV27(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 30 + uint256(w1) * 34 + uint256(w2) * 38;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV28(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 31 + uint256(w1) * 35 + uint256(w2) * 39;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV29(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 32 + uint256(w1) * 36 + uint256(w2) * 40;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV30(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 33 + uint256(w1) * 37 + uint256(w2) * 41;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV31(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 34 + uint256(w1) * 38 + uint256(w2) * 42;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV32(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 35 + uint256(w1) * 39 + uint256(w2) * 43;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV33(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 36 + uint256(w1) * 40 + uint256(w2) * 44;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV34(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 37 + uint256(w1) * 41 + uint256(w2) * 45;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV35(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 38 + uint256(w1) * 42 + uint256(w2) * 46;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV36(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 39 + uint256(w1) * 43 + uint256(w2) * 47;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV37(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 40 + uint256(w1) * 44 + uint256(w2) * 48;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV38(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 41 + uint256(w1) * 45 + uint256(w2) * 49;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV39(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 42 + uint256(w1) * 46 + uint256(w2) * 50;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV40(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 43 + uint256(w1) * 47 + uint256(w2) * 51;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV41(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 44 + uint256(w1) * 48 + uint256(w2) * 52;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV42(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 45 + uint256(w1) * 49 + uint256(w2) * 53;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV43(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 46 + uint256(w1) * 50 + uint256(w2) * 54;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV44(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 47 + uint256(w1) * 51 + uint256(w2) * 55;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV45(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 48 + uint256(w1) * 52 + uint256(w2) * 56;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV46(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 49 + uint256(w1) * 53 + uint256(w2) * 57;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV47(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 50 + uint256(w1) * 54 + uint256(w2) * 58;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV48(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 51 + uint256(w1) * 55 + uint256(w2) * 59;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV49(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 52 + uint256(w1) * 56 + uint256(w2) * 60;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV50(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 53 + uint256(w1) * 57 + uint256(w2) * 61;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV51(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 54 + uint256(w1) * 58 + uint256(w2) * 62;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV52(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 55 + uint256(w1) * 59 + uint256(w2) * 63;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV53(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 56 + uint256(w1) * 60 + uint256(w2) * 64;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV54(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 57 + uint256(w1) * 61 + uint256(w2) * 65;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV55(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 58 + uint256(w1) * 62 + uint256(w2) * 66;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV56(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 59 + uint256(w1) * 63 + uint256(w2) * 67;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV57(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 60 + uint256(w1) * 64 + uint256(w2) * 68;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV58(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 61 + uint256(w1) * 65 + uint256(w2) * 69;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV59(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 62 + uint256(w1) * 66 + uint256(w2) * 70;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV60(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 63 + uint256(w1) * 67 + uint256(w2) * 71;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV61(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 64 + uint256(w1) * 68 + uint256(w2) * 72;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV62(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 65 + uint256(w1) * 69 + uint256(w2) * 73;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV63(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 66 + uint256(w1) * 70 + uint256(w2) * 74;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV64(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 67 + uint256(w1) * 71 + uint256(w2) * 75;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV65(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 68 + uint256(w1) * 72 + uint256(w2) * 76;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV66(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 69 + uint256(w1) * 73 + uint256(w2) * 77;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV67(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 70 + uint256(w1) * 74 + uint256(w2) * 78;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV68(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 71 + uint256(w1) * 75 + uint256(w2) * 79;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }

    function _l33HulaTorqueV69(uint32 w0, uint32 w1, uint32 w2) internal pure returns (uint32) {
        uint256 t = uint256(w0) * 72 + uint256(w1) * 76 + uint256(w2) * 80;
        t = (t ^ (t >> 17)) * 0xed5ad4bb;
        t ^= (t >> 11);
        return uint32(t % 1000001);
    }
